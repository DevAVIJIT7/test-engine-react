...
import { faDownload, faCalendar, faDollarSign, faTasks, faComment, faComments } from '@fortawesome/free-solid-svg-icons';
                ...
                <div id="content">
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="d-flex flex-row">
                            <div class="card border-left-primary shadow h-100 py-2 col mb-4 mr-4">
                              <div class="card-body">
                            ...
                            <div class="card border-left-success shadow h-100 py-2 col mb-4 mr-4">
                              <div class="card-body">
                                <div className="row no-gutters align-items-center">
                                  <div className="col mr-2">
                                  ...
                                  <div className="col-auto">
                                    <FontAwesomeIcon className="fa-2x text-gray-300" icon={faDollarSign} />
                                  </div>
                              </div>
                              </div>
                            </div>

                            <div class="card border-left-info shadow h-100 py-2 col mb-4 mr-4">
                              <div class="card-body">
                                <div className="row no-gutters align-items-center">
                                  <div className="col mr-2">
                            ...
                            <div class="card border-left-warning shadow h-100 py-2 col mb-4">
                              <div class="card-body">
                              <div className="row no-gutters align-items-center">
                                  <div className="col mr-2">
                                  ...
                                  <div className="col-auto">
                                    <FontAwesomeIcon className="fa-2x text-gray-300" icon={faComments} />
                                  </div>
                              </div>
                              </div>
                            </div>
